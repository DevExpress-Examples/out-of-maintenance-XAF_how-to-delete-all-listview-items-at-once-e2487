...
Namespace DeleteAllListViewItems.Win
	Partial Public Class DeleteAllListViewItemsWindowsFormsApplication
		...
		Private Sub DeleteAllListViewItemsWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles Me.DatabaseVersionMismatch
#If EASYTEST Then
			e.Updater.Update()
			e.Handled = True
#Else
